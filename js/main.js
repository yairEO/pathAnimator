...
(function(){
	...
	function AnimateWalker(walker){
		...
		this.color = 'deeppink'; // to visually seperate different walkers easily
	}
	...
	AnimateWalker.prototype = {
		start : function(){
			...
			this.pathAnimator.context = this; // just a hack to save the context of every Walker inside it's pathAnimator
			this.pathAnimator.start( this.speed, this.step, this.reverse, this.startOffset, this.finish);
		},
		...
		resume : function(){
			this.pathAnimator.start( this.speed, this.step, this.reverse, this.pathAnimator.percent, this.finish);
		}
	}
